...
const tourSchema=mongoose.Schema({
    name:{
        ...
        minlength:[8,  'A tour must have more or equal then 8 charaters'],
    ...
    ratingsAverage:{
        type:Number,
        default:4.5,
        min:[1,'A tour must have more or equal then 1.0 ratingAverage'],
        max:[5,'A tour must have less or equal then 5.0 ratingAverage'],
